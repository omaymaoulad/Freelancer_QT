...
static constexpr auto qt_meta_stringdata_ZN9AddClientE = QtMocHelpers::stringData(
    "AddClient",
    "on_btnSave_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9AddClientE[] = {
...
Q_CONSTINIT const QMetaObject AddClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9AddClientE.offsetsAndSizes,
    qt_meta_data_ZN9AddClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9AddClientE_t,
        // Q_OBJECT / Q_GADGET
...
void *AddClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9AddClientE.stringdata0))
