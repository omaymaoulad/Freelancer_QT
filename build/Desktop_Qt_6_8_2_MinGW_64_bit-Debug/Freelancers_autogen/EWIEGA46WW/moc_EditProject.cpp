...
namespace {
struct qt_meta_tag_ZN11EditProjectE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11EditProjectE = QtMocHelpers::stringData(
    "EditProject",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11EditProjectE[] = {
...
Q_CONSTINIT const QMetaObject EditProject::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11EditProjectE.offsetsAndSizes,
    qt_meta_data_ZN11EditProjectE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11EditProjectE_t,
        // Q_OBJECT / Q_GADGET
...
void *EditProject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11EditProjectE.stringdata0))
